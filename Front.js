...
function media() {
    ...
    ${nota1}, ${nota2} e ${nota3}</mark> A média final será <mark>${media.toFixed(1)} 
    </mark>.</p>`
}

function trocarcores() {
    let listacores = ['green','blue','white','orange','gray','red','pink'];
        document.body.style.backgroundColor=listacores[Math.floor(7*Math.random())];
}
